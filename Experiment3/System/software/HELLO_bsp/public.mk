...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../Mini_Pro.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../labmininios.sopcinfo
...
# Design Name 
# setting SOPC_NAME is labmininios
SOPC_NAME := labmininios
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4081058
SOPC_SYSID_FLAG += --sidp=0x4081058
ELF_PATCH_FLAG  += --sidp 0x4081058

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1681173502
SOPC_SYSID_FLAG += --timestamp=1681173502
ELF_PATCH_FLAG  += --timestamp 1681173502
